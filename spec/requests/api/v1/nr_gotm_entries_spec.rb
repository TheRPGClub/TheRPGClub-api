...
RSpec.describe 'api/v1/nr_gotm_entries', type: :request do
  ...
  path '/api/v1/nr_gotm_entries' do
    ...
    post 'Create a Non-Retro GOTM entry' do
      tags 'Non-Retro GOTM'
  ...
  path '/api/v1/nr_gotm_entries/{id}' do
    ...
    patch 'Update a Non-Retro GOTM entry' do
      tags 'Non-Retro GOTM'
    ...
    put 'Replace a Non-Retro GOTM entry (alias)' do
      tags 'Non-Retro GOTM'
    ...
    delete 'Delete a Non-Retro GOTM entry' do
      tags 'Non-Retro GOTM'
